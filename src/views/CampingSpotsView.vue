                ...
                <div class="md:flex">
                  ...
                  <div class="md:w-2/3 p-6">
                    ...
                    <div class="flex items-center justify-between">
                      <div class="text-lg">
                        <span class="font-bold text-gray-900">${{ parseFloat(spot.price).toFixed(2) }}</span>
...
const fetchSpots = async () => {
  try {
    ...
    totalSpots.value = pagination.total
...
watch(() => route.query, (newQuery) => {
  if (newQuery.search) quickSearch.value = newQuery.search
  if (newQuery.location) filters.value.location = newQuery.location
  if (newQuery.capacity) filters.value.capacity = newQuery.capacity
